...
import { convertNumberToDecimal } from "reUseAbleFunctions/reuseAbleFunctions";
            ...
            <TableBody>
              {coins?.map((coins, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell>{convertNumberToDecimal(coins?.amount)}<span>{coins?.metadata?.symbol}</span></TableCell>
